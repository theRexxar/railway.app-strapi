...
async function seedPersonas(strapi) {
  ...
  const items = [
    { name: 'Calon PMI', slug: 'calon-pmi', excerpt: 'Berencana bekerja di luar negeri', description: '<p>Program dan layanan yang dirancang khusus untuk calon Pekerja Migran Indonesia. Dapatkan informasi lengkap tentang persyaratan, dokumen, dan persiapan sebelum berangkat ke luar negeri.</p>', background_color: '#1A5276', is_featured: true, order: 1, meta_seo: { meta_title: 'Calon PMI - JARI PMI', meta_description: 'Informasi untuk calon Pekerja Migran Indonesia' } },
    { name: 'PMI Aktif', slug: 'pmi-aktif', excerpt: 'Sedang bekerja di luar negeri', description: '<p>Layanan dan perlindungan untuk Pekerja Migran Indonesia yang sedang aktif bekerja di luar negeri. Akses informasi tentang hak-hak pekerja, pengaduan, dan dukungan selama masa penempatan.</p>', background_color: '#117864', is_featured: true, order: 2, meta_seo: { meta_title: 'PMI Aktif - JARI PMI', meta_description: 'Informasi untuk PMI yang sedang bekerja di luar negeri' } },
    { name: 'Keluarga PMI', slug: 'keluarga-pmi', excerpt: 'Keluarga pekerja migran Indonesia', description: '<p>Informasi dan dukungan untuk keluarga Pekerja Migran Indonesia. Temukan panduan komunikasi, pengelolaan keuangan, dan program pemberdayaan keluarga PMI.</p>', background_color: '#7D3C98', is_featured: false, order: 3, meta_seo: { meta_title: 'Keluarga PMI - JARI PMI', meta_description: 'Informasi untuk keluarga Pekerja Migran Indonesia' } },
    { name: 'Purna PMI', slug: 'purna-pmi', excerpt: 'Telah selesai bekerja di luar negeri', description: '<p>Program reintegrasi dan pemberdayaan untuk PMI yang telah selesai bekerja di luar negeri. Dapatkan informasi tentang kewirausahaan, pelatihan keterampilan, dan bantuan modal usaha.</p>', background_color: '#B7950B', is_featured: false, order: 4, meta_seo: { meta_title: 'Purna PMI - JARI PMI', meta_description: 'Informasi untuk PMI yang telah selesai bekerja di luar negeri' } },
  ]
  const ids = {}
  for (const item of items) {
    const doc = await strapi.documents(uid).create({ data: { ...item } })

  ...
  const items = [
    {
      ...
      description: '<p>Bapak Turidjo Hadi dan Ibu Sri Titin adalah Purna PMI yang sukses membangun usaha minuman herbal instan dengan merek Saripati Laer. Setelah bertahun-tahun bekerja di luar negeri, mereka kembali ke Cilegon dan memanfaatkan pengalaman serta tabungan untuk merintis usaha berbasis bahan herbal lokal. Kini Saripati Laer telah menyerap 20 tenaga kerja dan memasarkan produknya hingga ke pasar ekspor.</p>',
      contacts: [{ type: 'phone_number', value: '081960615933', label: 'Bapak Turidjo Hadi' }, { type: 'instagram', value: '@saripatilaer', label: 'Saripati Laer Official' }],
    ...
    },
    {
      ...
      description: '<p>Bapak Ahmad Suhendra adalah Purna PMI asal Lampung yang berhasil mengembangkan usaha mebel kayu jati dan mahoni. Bermodalkan keterampilan pertukangan yang diasah selama bekerja di luar negeri, ia membangun Suhendra Furniture yang kini memproduksi 50 unit mebel per bulan dengan omzet Rp 80 juta. Usahanya telah menjadi inspirasi bagi Purna PMI lainnya di Lampung.</p>',
      contacts: [{ type: 'phone_number', value: '081234567890', label: 'Bapak Ahmad Suhendra' }],
